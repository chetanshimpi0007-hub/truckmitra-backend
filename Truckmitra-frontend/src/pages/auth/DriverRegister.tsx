            ...
            {step === 1 && (
              <div className="space-y-6 animate-fadeIn">
                <div className="grid grid-cols-1 gap-6">
                  ...
                  <InputField label="Created Password" type="password" name="password" value={formData.password} onChange={handleChange} icon={<HiLockClosed />} placeholder="Minimum 6 characters" required minLength={6} />
                </div>
                <div className="pt-6">
  ...
  <div>
    ...
    <div className="relative group">
      ...
      <input
        ...
        onChange={onChange}
        {...rest}
        className={`block w-full ${icon ? 'pl-11' : 'pl-4'} pr-4 py-3.5 bg-gray-50 border-2 border-gray-50 rounded-xl focus:bg-white focus:border-blue-600 focus:outline-none transition-all placeholder:text-gray-400 text-gray-800 font-medium`}
